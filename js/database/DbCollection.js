...
class DbCollection extends Base_js_1.Base {
    ...
    getDataByFilter(filter, sort = true, limit = 100) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getDataByLastId(id, limit = 100, filter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cursor = this._collection.find(Object.assign(Object.assign({}, filter), { $expr: { $lt: [{ '$toLong': '$id' }, int] } })).sort({ createdTimestamp: -1 }).limit(limit);
            const find = yield cursor.toArray();
            return find;
        });
    }
    getNewestData(limit, filter) {
        return __awaiter(this, void 0, void 0, function* () {
            const cursor = this._collection.find(filter !== null && filter !== void 0 ? filter : {}).sort({ $natural: -1 }).limit(limit !== null && limit !== void 0 ? limit : 100);
            const find = yield cursor.toArray();
            return find;
        });
    }
