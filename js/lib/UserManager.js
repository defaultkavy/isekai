...
class UserManager extends BaseManager_js_1.BaseManager {
    ...
    build(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const builder = Object.assign(Object.assign({}, data), { avatar: data.avatar ? yield this.client.assets.fetch(data.avatar.id).catch(err => undefined) : undefined, cover: data.cover ? yield this.client.assets.fetch(data.cover.id).catch(err => undefined) : undefined });
